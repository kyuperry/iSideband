...
// LocationTelemetryFields returns Sideband-compatible LXMF telemetry fields.
// Android Sideband stores FIELD_TELEMETRY (0x02) and uses its location sensor
// (SID 0x02) to populate the Situation Map.
