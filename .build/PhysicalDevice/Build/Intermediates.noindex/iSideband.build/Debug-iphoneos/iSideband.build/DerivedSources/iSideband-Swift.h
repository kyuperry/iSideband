...
#ifndef ISIDEBAND_SWIFT_H
#define ISIDEBAND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iSideband",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9iSideband16BluetoothManager")
@interface BluetoothManager : NSObject <UNUserNotificationCenterDelegate>
...
@class CBPeripheral;
@class NSNumber;
@interface BluetoothManager (SWIFT_EXTENSION(iSideband)) <CBCentralManagerDelegate>
...
@interface BluetoothManager (SWIFT_EXTENSION(iSideband)) <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC9iSideband24LocationTelemetryManager")
@interface LocationTelemetryManager : NSObject
...
@class CLLocation;
@interface LocationTelemetryManager (SWIFT_EXTENSION(iSideband)) <CLLocationManagerDelegate>
